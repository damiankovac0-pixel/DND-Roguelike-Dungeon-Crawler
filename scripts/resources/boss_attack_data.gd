...
@export var selection_weight: int = 1
@export var min_player_distance: float = 0.0
@export var max_player_distance: float = 0.0
...
@export var hazard_turns: int = 0
@export var hazard_damage_dice: int = 0
@export var hazard_damage_sides: int = 4
@export var hazard_damage_bonus: int = 0
@export var hazard_damage_type: StringName = &"magic"
@export var hazard_effect: StringName = &""
@export var hazard_glyph: String = ""
@export var hazard_vfx_id: StringName = &""
@export var hazard_message: String = ""
